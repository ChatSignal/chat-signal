...
function setupOptionsDom() {
  const elements = {
    ...
    'topic-min-count': createElement({ value: '5' }),
    'spam-threshold': createElement({ value: '3' }),
    'duplicate-window': createElement({ value: '30' }),
    'sentiment-sensitivity': createElement({ value: '3' }),
    'mood-upgrade-threshold': createElement({ value: '30' }),
